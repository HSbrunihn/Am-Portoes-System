...
export interface Tarefa{id:number;titulo:string;descricao:string|null;valor:number|null;dataVencimento:string;status:StatusTarefa} export interface TarefaRequest{titulo:string;descricao:string;valor?:number;dataVencimento:string}
export interface Orcamento extends Tarefa{valor:number} export interface OrcamentoRequest extends TarefaRequest{valor:number}
